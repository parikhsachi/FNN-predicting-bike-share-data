...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        error = target - final_output # Output layer error is the difference between desired target and actual output.
        ...
        delta_weights_h_o += output_error_term*hidden_error_term
    ...
    def run(self, features):
        ...
        hidden_inputs = np.dot(x,self.weights_input_to_hidden) # signals into hidden layer
        hidden_outputs = sigmoid(hidden_input) # signals from hidden layer
